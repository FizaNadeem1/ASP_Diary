...
class Branch extends AppComponentBase<IBranchProps, IBranchState> {
  ...
  public render() {
    ...
    const columns = [
      ...
      {title:L('firmName'),dataIndex:'firmName',key:'firmName',width:'auto', render: (text: string) => <div>{text}</div>},
      {title:L('cityName'),dataIndex:'cityName',key:'cityName',width:'auto', render: (text: string) => <div>{text}</div>},
      {
        title: L('Actions'),
        key: 'actions',
        width: 150,
